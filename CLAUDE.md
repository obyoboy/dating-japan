# CLAUDE.md — Dating in Japan Guide

## プロジェクト概要

**目的:** 日本人女性とデートしたい外国人男性向けハウツーサイトの記事を自動生成・自動投稿する
**サイト名:** Dating in Japan Guide
**ターゲット:** 日本人女性と付き合いたい・デートしたい外国人男性
**対応言語:** 英語（en）・タガログ語（tl）・ベトナム語（vi）
**GitHubリポジトリ:** https://github.com/obyoboy/dating-japan
...
**命名規則:** 3言語すべて同じslugを使う（例: `en/understanding-japanese-dating-culture.html`）
